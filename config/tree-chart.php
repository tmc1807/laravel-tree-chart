...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Default gap between sibling cards (px)
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Default minimum card height (px)
    |--------------------------------------------------------------------------
    |
    | Set a value to give all cards a uniform minimum height. Leave null to let
    | each card size itself to its content.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Default card font size (px)
    |--------------------------------------------------------------------------
    |
    | Base font size for card text (header and title). The sub-label scales
    | proportionally. Pass a number in px, e.g. 11.
    |
    */
